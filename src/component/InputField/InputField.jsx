...
//                 <span className={props.labelClass ? props.labelClass : "label-hide"}>{props.labelName}</span>
//                 <label htmlFor="">
...
//                 <input
//                     id={props.id}
//                     className={`input-box ${props.type === "file" ? "inp-file" : "input"} ${active} ${isError} ${disabledClass} ${props.inputClass}`}
...
const InputField = (props) => {
    ...
    return (
        <div className={`single-input ${props.className || ''}`}>
            ...
            {props.labelName && (
                <span className={props.labelClass ? props.labelClass : "label-hide"}>
                    {props.labelName}
                </span>
            )}
            ...
            {props.label?.trim() && (
                <label htmlFor={props.id || undefined}>
                    ...
                    {props.labelOnChangeCallback && !props.showChangeField && (
                        <span className="link">
                            <a href="#!" onClick={props.labelOnChangeCallback}>
                                {props.labelLinkText}
                            </a>
                        </span>
                    )}
            ...
            {props.groupIcon && (
                <i className={`group-icon ${props.groupIcon}`}></i>
            )}
